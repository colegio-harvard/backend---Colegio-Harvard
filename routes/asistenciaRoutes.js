...
router.post('/registrar', verificarToken, verificarRol('PORTERIA', 'SUPER_ADMIN'), ctrl.registrarEvento);
...
router.get('/historial-porteria', verificarToken, verificarRol('PORTERIA', 'SUPER_ADMIN'), ctrl.historialPorteria);
